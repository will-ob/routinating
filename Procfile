...
consul-template: $(sleep 10 &&  sudo ./bin/consul-template -consul 127.0.0.1:8500 -template "./haproxy.ctmpl:./build/haproxy.cfg:haproxy -f ./build/haproxy.cfg -p ./pids/haproxy.pid -sf $(cat ./pids/haproxy.pid)")
